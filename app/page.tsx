      ...
      <section className="border-b border-[#E4EBF0] px-6 py-9 sm:hidden">
        <div className="mx-auto max-w-md">
          ...
          <div className="mt-7 flex flex-wrap items-center gap-x-6 gap-y-4">
            <Link
              href="/contact"
              className="inline-flex min-h-11 items-center justify-center rounded-full bg-[#718CA2] px-6 text-sm font-medium text-white transition-all duration-200 hover:-translate-y-0.5 hover:bg-[#607D93] hover:shadow-md"
            >
