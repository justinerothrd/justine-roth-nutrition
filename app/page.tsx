    ...
    <main className="min-h-screen bg-white text-[#34414E]">
      ...
      <section className="border-b border-[#E4EBF0] px-6 py-10 sm:py-12 md:py-16">
        <div className="mx-auto max-w-5xl">
          <div className="max-w-4xl">
            ...
            <h1 className="font-heading mt-5 max-w-3xl text-[2.25rem] font-normal leading-[1.08] tracking-[-0.035em] sm:text-4xl md:text-[3rem]">
              What does healthy mean to you?
            </h1>

            {/* Shorter mobile copy */}
            <div className="mt-6 space-y-4 text-base leading-7 text-[#687785] sm:hidden">
      ...
      <section className="border-b border-[#E4EBF0] px-6 py-12 md:py-16">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-8 grid border-y border-[#E4EBF0] md:mt-9 md:grid-cols-3">
      ...
      {/* About */}
      <section className="border-b border-[#E4EBF0] px-6 py-12 md:py-16">
        <div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-[200px_1fr] md:gap-14">
          <div>
            <p className="text-xs font-medium uppercase tracking-[0.26em] text-[#829CB1]">
              About
            </p>
          ...
          <div>
            <h2 className="font-heading max-w-3xl text-3xl font-normal leading-tight tracking-[-0.03em]">
              Experienced nutrition care without judgment or rigid rules.
            </h2>

            <p className="mt-5 max-w-3xl text-lg leading-8 text-[#687785]">
      ...
      {/* Contact */}
      <section className="border-b border-[#DCE6ED] bg-[#F3F7FA] px-6 py-12 md:py-16">
